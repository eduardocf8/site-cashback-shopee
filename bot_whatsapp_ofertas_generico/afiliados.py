...
class ConversorAfiliados:
    ...
    def obter_conversoes_por_produto(self, inicio, fim):
        ...
        por Sub ID (exatamente como retornado pela API da Shopee), com
        ...
        atraves de mais de um Sub ID no periodo.
    ...
    # Retorna o Sub ID exatamente como veio da API da Shopee, sem nenhuma
    # classificacao/categoria embutida. Cada conta de afiliado usa Sub IDs
    # com seu proprio significado/convencao, entao esse tipo de mapeamento
    # (ex: agrupar por origem de campanha) fica a cargo de quem configura o
    # bot - nao faz sentido embutir regras especificas de um negocio aqui.
    def classificar_sub_id_relatorio(self, sub_id):
        texto = str(sub_id or "").strip()
        return texto if texto else "sem_subid"
