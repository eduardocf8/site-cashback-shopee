...
class MainWindow(QMainWindow):
    ...
    def build_ui(self):
        ...
        self.sub_ids_input.setPlaceholderText("Opcional: whatsapp, grupo01, bot01")
        ...
        self.indicators_chart.setPlaceholderText("O gráfico por Sub ID aparecerá aqui.")
        ...
        email_report_intro = QLabel(
            ...
            "comissão por Sub ID (ontem + mês atual até agora). Funciona mesmo "
    ...
    def render_indicators_report(self, report):
        ...
        if rows:
            self.indicators_summary_label.setText(f"{len(rows)} Sub ID(s)")
        else:
    ...
    def exportar_conversoes_excel(self):
        ...
        cabecalhos = ["Produto", "Loja", "Quantidade", "Preço", "Comissão", "Última compra", "Sub ID"]
        linhas = []
        for p in produtos:
            ultima = p.get("ultima_compra")
            linhas.append([
